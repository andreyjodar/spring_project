...
public class User extends BaseEntity implements UserDetails {
    ...
    public Boolean isAdmin() {
        return profiles.stream().anyMatch(role -> role.getRole().equals("ADMIN"));
    }

    @JsonIgnore
    public Boolean isSeller() {
        return profiles.stream().anyMatch(role -> role.getRole().equals("SELLER"));
    }
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return profiles.stream().map(role -> new SimpleGrantedAuthority(role.getRole()))
